...
// main js file by Abuzcoder
// email : abuzcoder@gmail.com

class Nav {
  constructor(nav, sidebar, footer) {
    ...
    this.links = {
      ...
      media: ["Новости", "Объявления", "Статьи", "Галерея"],
      cooperation: [],
      studying_proccess: [],
      poster: [],
    };
  ...
  init() {
    this.element.innerHTML = `<div class="container mx-auto px-4">
      <div class="row flex flex-wrap justify-between">
        <div class="navbar-brand">
          <a href="./index.html" class="text-white text-lg font-bold flex items-center gap-4">
        ...
        <div class="navbar-content flex flex-wrap items-center gap-14">
          ...
          <div class="btn-menu hamburger-menu">
            <button onClick>
              <span></span>
              <span></span>
            </button>
        ...
        <div class="flex flex-wrap sm:gap-0 gap-8 items-end justify-between">
          ...
          <div class="contacts">
            ...
            <ul class="flex items-center gap-[30px]">
              ...
              <li>
                <a href="#!">
                  <img src="./img/instagram-line.svg" alt="">
                </a>
              </li>
              <li>
                <a href="#!">
            ...
            <div class="flex items-center sm:w-auto w-full">
              ...
              <button class="py-[14px] px-[16px] bg-[#1d9a84]">
                <svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 1L7.5597 6.70179C7.79113 6.90296 7.78863 7.26313 7.55442 7.46106L1 13" stroke="white"
                    stroke-width="2" />
                </svg>
              </button>
            </div>
    ...
    <div class="container mx-auto px-4">
      <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
        <div class="">
          <div class="navbar-brand">
            <a href="#!" class="text-white  text-lg flex items-center gap-4">
              <div class="w-12 h-12 rounded-full bg-[#1D9A84]"></div>
              <span class="font-bold font-roboto">USPENSKI <br class="" />
                SCHOOL</span>
            </a>
          </div>
          <div class="flex flex-around">
            <a href="!#"><img src="./img/facebook.png" class="m-5" /></a>
            <a href="!#"><img src="./img/instag.png" class="m-5" /></a>
            <a href="!#"><img src="./img/teleg.png" class="m-5" /></a>
          </div>
          <p class="text-white mt-5 font-montserrat ">© 2021 Uspenski school</p>
        </div>
        <div class="">
          <ul class="text-white nav-links">
            <li class="mb-5"><a href="!#">Образование</a></li>
            <li class="mb-5"><a href="!#">Школа</a></li>
            <li class="mb-5"><a href="!#">Медиа</a></li>
            <li class="mb-5"><a href="!#">Сотрудничество</a></li>
          </ul>
        </div>
        <div class="">
          <ul class="text-white nav-links">
            <li class="mb-5"><a href="!#">Учебный процесс</a></li>
            <li class="mb-5"><a href="!#">Афиша</a></li>
            <li class="mb-5"><a href="!#">Поступление</a></li>
            <li class="mb-5"><a href="!#">Подготовительные курсы</a></li>
          </ul>
        </div>
        <div class="md:flex items-around">
          <div class="text-white text-[18px]">
            ...
            <div class="flex items-end">
              <input type="email" placeholder="Ваш e-mail" class="bg-transparent focus:outline-none border-b pb-2.5" />
              <button class="btn-right bg-[#1D9A84] px-4 py-3.5 cursor-pointer">
                <svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 1L7.5597 6.70179C7.79113 6.90296 7.78863 7.26313 7.55442 7.46106L1 13" stroke="white"
                    stroke-width="2" />
                </svg>
  ...
  toggleHamburgerMenu(elem) {
    if (elem.classList.contains("active")) {
      ...
      this.sidebar.querySelector(".sidebar").classList.remove("active");
    } else {
      elem.classList.add("active");
      document.body.style.overflow = "hidden";
      this.sidebar.querySelector(".sidebar").classList.add("active");
    }
  }
  initSidebar() {}
}
class Accordion {
  constructor(element) {
    ...
    this.accordion = this.element.querySelectorAll(".accordion-header");
    this.accordionItem = this.element.querySelectorAll(".accordion-item");
    this.accordionBody = this.element.querySelectorAll(".accordion-body");
    this.accordionPlus = this.element.querySelectorAll(".accordion-plus");
  }
  init() {
    const $this = this;
    this.accordionItem.forEach((item, idx) => {
      if (idx == 0) {
        item.classList.add("border-t-2");
        item.classList.add("border-[#1D9A84]");
    ...
    this.accordion.forEach((item) => {
      item.addEventListener("click", function (e) {
        const accardionBody = this.nextElementSibling;
        const accordionPlus = this.querySelector(".accordion-plus");
        if (!accardionBody.classList.contains("active")) {
          $this.closeAccordionBody($this.accordionBody);
          $this.closeAccordionHeader($this.accordion);
          $this.closeAccordionPlus($this.accordionPlus);
          accardionBody.classList.add("active");
          accordionPlus.classList.add("active");
        } else {
          accardionBody.classList.remove("active");
          accordionPlus.classList.remove("active");
        }
      });
    });
  }
  closeAccordionBody(items) {
    items.forEach((item) => {
      item.classList.remove("active");
    });
  }
  closeAccordionHeader(items) {
    items.forEach((item) => {
      item.classList.remove("mb-[15px]");
    });
  }
  closeAccordionPlus(items) {
    items.forEach((item) => {
      item.classList.remove("active");
    });
  }
...
class CourseGallery {
  constructor(element, parentCourse) {
    this.gallery = document.querySelectorAll(element);
    this.chunkGallery = this.sliceIntoChunks([...this.gallery], 4);
    this.parent = document.querySelector(parentCourse);
  }
  init() {
    this.chunkGallery.forEach((item, idx) => {
      if (idx % 2 !== 0) {
        let firstElement = item[0];
        let secondElement = item[1];
        item[0] = secondElement;
        item[1] = firstElement;
      }
    });
    ...
    this.chunkGallery.forEach((item, idx) => {
      for (let i = 0; i < item.length; i++) {
        this.parent.appendChild(item[i]);
      }
    });
    this.chunkGallery.forEach((item, idx) => {
      if (idx % 2 == 0) {
        item[0].classList.add("sm:col-span-2");
        item[0].classList.add("sm:row-span-2");
        item[1].classList.add("sm:col-span-2");
      } else {
        item[0].classList.add("sm:col-span-2");
        item[1].classList.add("sm:col-span-2");
        item[1].classList.add("sm:row-span-2");
      }
    });
  }
...
class CounterScale {
  ...
  init() {
    this.element.forEach((item) => {
      const counter = Number(item.innerHTML);
      this.counterFunc(item, counter);
    });
  }
  counterFunc(item, to) {
    let counter = 0;
...
class GridGallery {
  ...
  init() {
    ...
    const chunkGalleryLg = new CourseGallery().sliceIntoChunks(
      [...this.gallery],
      3
    );
    const chunkGalleryMd = new CourseGallery().sliceIntoChunks(
      [...this.gallery],
      2
    );
    ...
    if (mqMd.matches) {
      chunkGalleryMd.forEach((item, idx) => {
      ...
      chunkGalleryLg.forEach((item, idx) => {
        item.forEach((item, idx) => {
          if (idx % 2 !== 0) {
            item.style.transform = "translateY(70px)";
          }
